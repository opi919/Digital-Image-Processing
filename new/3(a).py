...
# Apply average filter with a 5x5 kernel
average_filtered_image = apply_average_filter(noisy_image, 5)
plt.subplot(1, 3, 2)
plt.title("Average Filtered Image")
plt.imshow(average_filtered_image, cmap="gray")

# Apply median filter with a 5x5 kernel
median_filtered_image = apply_median_filter(noisy_image, 5)
plt.subplot(1, 3, 3)
